...
public class CharacteristicDetailsAdapter extends BaseAdapter {
	private final static String TAG = "CharacteristicDetailsAdapter";
	...
	public void newValueForCharacteristic(final BluetoothGattCharacteristic ch, final String strVal, final int intVal,
	...
	public View getView(int position, View convertView, ViewGroup p) {
		...
		fields.writeBtn
				.setEnabled((props & (BluetoothGattCharacteristic.PROPERTY_WRITE | BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE)) != 0);
