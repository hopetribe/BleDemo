...
public class BleDefinedUUIDs {
	...
	public static class Service {
		...
		final static public UUID SERIVCE_LEDLIGHT         = UUID.fromString("0000f1ee-0000-1000-8000-00805f9b34fb");
	};
	...
	public static class Characteristic {
		...
		final static public UUID CHAR_LEDLIGHT            = UUID.fromString("0000f1ee-0000-1000-8000-00805f9b34fb");
	}
